...
use Fintech\MetaData\Exceptions\Eloquent\BankBranchRepository;
...
class BankBranchRepository implements InterfacesCountryRepository
{
    ...
    public function create(array $attributes = [])
    {
        try {
            ...
            throw new BankBranchRepositoryException($e->getMessage(), 0, $e);
        }
    ...
    public function update(int|string $id, array $attributes = [])
    {
        ...
        try {
            ...
            throw new BankBranchRepositoryException($exception->getMessage(), 0, $exception);
        }
