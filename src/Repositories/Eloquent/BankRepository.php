 ...
 */
class BankRepository implements InterfacesBankRepository
{
    /**
     * @var Model
     */
...
if ($this->model->saveOrFail()) {
            ...
            throw new BankRepositoryException($e->getMessage(), 0, $e);
        }
    ...
    public function update(int|string $id, array $attributes = [])
    {
        ...
        try {
            ...
            throw new BankRepositoryException($exception->getMessage(), 0, $exception);
        }
