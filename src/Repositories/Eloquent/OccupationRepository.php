...
use Fintech\MetaData\Exceptions\Eloquent\OccupationRepository;
...
class OccupationRepository implements InterfacesCountryRepository
{
    ...
    public function create(array $attributes = [])
    {
        try {
            ...
            throw new OccupationRepositoryException($e->getMessage(), 0, $e);
        }
    ...
    public function update(int|string $id, array $attributes = [])
    {
        ...
        try {
            ...
            throw new OccupationRepositoryException($exception->getMessage(), 0, $exception);
        }
